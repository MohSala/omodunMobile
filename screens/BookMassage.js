    ...
    return (
      <View style={{ flex: 1, backgroundColor: "#F8FFFF" }}>
        ...
        >
          ...
          >
            The Nuru massage is a special massage used to control stress and
            relaxation with a happy ending
          </Text>
        </Card>
        ...
        <View style={{ flex: 1, alignItems: "center", marginTop: 10 }}>
          ...
          >
            <Text style={styles.textButton}>
              {!this.state.pickedDate
                ? "SELECT DATE"
                : this.state.pickedDate.toString()}
            </Text>
          </TouchableOpacity>
          ...
          >
            *N.B: All our massages are performed with vetted and trusted sensual
            oils and candles to achieve maximum effect and last for 50 minutes.
          </Text>
